...
func TestPostalCodeProvider_GeocodeByMunicipalitiesBatch(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			municipalities: []string{"Paris", "Marseille", "Lyon"},
			wantFound:      3,
			wantNotFound:   0,
		},
		{
			name:           "mixed valid and invalid",
			municipalities: []string{"Paris", "NonExistent", "Lyon"},
			wantFound:      2,
			wantNotFound:   1,
		},
		{
		...
		},
		{
			...
			municipalities: []string{"Toulouse"},
			wantFound:      1,
			wantNotFound:   0,
		},
		{
			name:           "with whitespace",
			municipalities: []string{" Paris ", "  Lyon"},
			wantFound:      2,
			wantNotFound:   0,
		},
	}
...
func TestPostalCodeProvider_GeocodeByMunicipalitiesBatch_Large_Batch(t *testing.T) {
	...
	municipalities := []string{
		...
		"Rennes", "Reims", "Toulon", "Le Havre", "Grenoble",
	}
