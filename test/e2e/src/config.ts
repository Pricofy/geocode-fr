 ...
 * 
 * The Lambda function name is 'pricofy-geocode-fr' for both dev and prod environments.
...
export function getConfig(): TestConfig {
  ...
  // The function is deployed as 'pricofy-geocode-fr' in both dev and prod accounts
  const defaultFunctionName = 'pricofy-geocode-fr';
