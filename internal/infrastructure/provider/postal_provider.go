...
// PostalCodeProvider provides access to French postal code data.
...
//
// Parameters:
//   - postalCode: French postal code (5 digits, e.g., "75001")
//
// Returns:
...
//
// Parameters:
//   - postalCode: French postal code to validate (5 digits)
//
// Returns:
